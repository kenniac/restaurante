...
if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2) {
    ...
    if (!empty($_POST)) {
        ...
        if (empty($plato) || empty($precio) || $precio < 0 || empty($categoria_id)) {
            $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
                        Todos los campos son obligatorios, incluyendo la categoría.
            ...
            if (empty($id)) {
                $query_insert = mysqli_query($conexion, "INSERT INTO platos (nombre, precio, imagen, categoria_id) VALUES ('$plato', '$precio', '$nombre', $categoria_id)");
                ...
                $query_update = mysqli_query($conexion, "UPDATE platos SET nombre = '$plato', precio = $precio, imagen = '$nombre', categoria_id = $categoria_id WHERE id = $id");
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" id="tbl">
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($conexion, "SELECT platos.*, categorias.nombre as categoria_nombre FROM platos 
                                                                        LEFT JOIN categorias ON platos.categoria_id = categorias.id
                                    ...
                                    while ($data = mysqli_fetch_assoc($query)) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $data['categoria_nombre']; ?></td>
